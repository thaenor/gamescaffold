...
<head>
    ...
    <title>Celfocus Gamification</title><!-- includes at head-->
    ...
    'stylesheet' type='text/css'><!-- outdated browser pluggin-->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul class="nav nav-tabs">
                    ...
                    <li class="">
                        <a data-toggle="tab" href="#messages">Some
                        chart(ToDo)</a>
                    </li>
                ...
                <div class="tab-content">
                    <div class=
                    "tab-pane fade active in col-md-6 col-sm-3 col-lg-6" id=
                    "home">
                        <h4>Tickets</h4>
                    ...
                    <div class="tab-pane fade" id="profile">
                        ...
                        <p class="bigEntrance">this will show a tab with
                        rewards available</p>
                    </div>
                    ...
                    <div class="tab-pane fade" id="messages">
                        ...
                        <div class=
                        "col-md-6 col-lg-12 col-xs-12 well bigEntrance">
                            <a class="twitter-timeline" data-widget-id=
                            "598535731947122688" href=
                            "https://twitter.com/Celfocus">Tweets by
                            @Celfocus</a> <script>
